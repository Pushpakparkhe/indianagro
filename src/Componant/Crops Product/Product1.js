 ...
 function Product1()  {
    ...
    <div class="mainbox1">
        ...
        <div class="middle-card1 ps-4">
           ...
           <h3>Affect</h3>
           <ul>
            <li>It affects the plant growth.</li>
           </ul>
           <h3>Solution</h3>
           <ul>
            <li>Product</li>
    ...
    <div class="mainbox1">
        ...
        <div class="middle-card1 ps-4">
           ...
           <h3>Affect</h3>
           <ul>
            <li>Premature death of older leaves.</li>
           </ul>
           <h3>Solution</h3>
           <ul>
            <li>Product</li>
    ...
    <div class="mainbox1">
        ...
        <div class="middle-card1 ps-4">
           ...
           <h3>Affect</h3>
           <ul>
            <li>The leaves are narrow and short,reduces the sucrose content.</li>
           </ul>
           <h3>Solution</h3>
           <ul>
            <li>Product</li>
    ...
    <div class="mainbox1">
        ...
        <div class="middle-card1 ps-4">
           ...
           <h3>Affect</h3>
           <ul>
            <li>Fibre content is reduced .</li>
           </ul>
           <h3>Solution</h3>
           <ul>
            <li>Product</li>
